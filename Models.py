...
class ResidualBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1):
        ...
        # Se utiliza para ajustar las dimensiones cuando las entradas y salidas tienen diferentes tamaños de canal
...
class ConvAE128(nn.Module):
    """
    Convolutional autoencoder designed to reconstruct images with 4 layers in encoder and decoder.
    """
