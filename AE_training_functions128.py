...
class TestModel:
    ...
    def plot_reconstructions(self, imgs_original, imgs_reconstruction):
        print(imgs_original.min(), imgs_original.max(), imgs_reconstruction.min(), imgs_reconstruction.max())
    ...
    def reconstruct(self):
        ...
        # valid_encodings = self._model.flatten(valid_encodings)
        # valid_encodings = self._model.encoder_fc(valid_encodings)
